    ...
    >
      ...
      >
        ...
        <motion.div variants={item}>
          ...
          />
          {errors.password && <span className="mt-1 text-xs text-red-500">This field is required</span>}
        </motion.div>
        ...
        <motion.div variants={item} className="flex items-center justify-between">
          <label className="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
            <input
              type="checkbox"
              className="h-4 w-4 rounded border-zinc-300 text-emerald-500 focus:ring-emerald-400 dark:border-zinc-600"
            />
            Remember me
          </label>
          <Link href="#" className="text-sm font-medium text-emerald-600 hover:text-emerald-500 dark:text-emerald-400">
            Forgot password?
          </Link>
        </motion.div>
